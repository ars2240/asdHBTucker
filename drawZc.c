...
void drawZc(double *sampIn, double *sampOut, size_t sampSize, double *phi,
        double *psi1, double *psi2, double *r1, double *r2, size_t r1Size,
        const mwSize *phiDims, const mwSize *psi1Dims,
         const mwSize *psi2Dims);
double get_random();
...
void drawZc(double *sampIn, double *sampOut, size_t sampSize, double *phi,
        ...
        const mwSize *phiDims, const mwSize *psi1Dims,
         const mwSize *psi2Dims)
{
    int x = sampIn[0]; //get evidence variable
    int y = sampIn[1]; //get response variable
    int z = sampIn[4]; //get other topic
    ...
    sampOut[3] = r1[z-1]; //set topic
    
    // sample other z
    y = sampIn[2]; // get response variable
                 ...
                 int nrhs, const mxArray *prhs[])
{
    ...
    size_t ncols, res1Size; // number of columns of sample
    ...
    drawZc(sIn,sOut,ncols,core,aux1,aux2,res1,res2,res1Size,coreDims,aux1Dims,aux2Dims);
}
