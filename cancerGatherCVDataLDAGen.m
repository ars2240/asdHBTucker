...
for i=1:nFolds
    ...
    phi{i}=csvread(['data/cancer_py_gen_gvLDA_', int2str(nTop), '_', ...
        int2str(i), '_train.csv'],1,1);
    testPhi{i}=csvread(['data/cancer_py_gen_gvLDA_', int2str(nTop), '_', ...
...
save('cancerHBTuckerCVData_gvLDAGen.mat','phi', 'testPhi', 'cvTestASD','cvTrainASD');