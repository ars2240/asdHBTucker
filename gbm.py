...
for N in N_v:
    ...
    plt.savefig('plots/gbm_AUC_' + str(N) + '_' + str(fname) + '.png')
    ...
    print('%6s\t %6.3d\t %0.4f\t %0.4f\t %0.4f' % ('valid', N, mean_auc, std_auc, p_val))
    print('%6s\t %6.3d\t %0.4f\t %0.4f\t %0.4f' % ('train', N, np.mean(aucs_tr), np.std(aucs_tr), p_val_tr))